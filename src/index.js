...
const { lightningChart, Themes, AxisScrollStrategies, LUT, regularColorSteps, PalettedFill, emptyLine, synchronizeAxisIntervals, AxisTickStrategies, htmlTextRenderer, } = lcjs
